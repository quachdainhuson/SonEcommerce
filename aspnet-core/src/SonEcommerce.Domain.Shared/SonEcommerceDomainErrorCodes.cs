...
public static class SonEcommerceDomainErrorCodes
{
    /* You can add your business exception error codes here, as constants */
    public const string ProductNameAlreadyExists = "SonEcommerce:ProductNameAlreadyExists";
    ...
    public const string ProductCategoryIsNotExists = "SonEcommerce:ProductCategoryIsNotExists";
