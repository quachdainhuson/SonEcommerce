...
public class SonEcommerceDbContext :
    AbpDbContext<SonEcommerceDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(SonEcommerceConsts.DbTablePrefix + "YourEntities", SonEcommerceConsts.DbSchema);
        ...
        builder.Entity<OrderItem>(b =>
        {
            ...
            b.ConfigureByConvention();
            b.HasOne<Product>().WithOne().HasForeignKey<OrderItem>(oi => oi.ProductId);
