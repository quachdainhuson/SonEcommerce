...
import { ProductAttributeValueDto, ProductDto, ProductsService,  } from '@proxy/products';
...
export class ProductAttributeComponent implements OnInit, OnDestroy {
  ...
  removeItem(attribute: ProductAttributeValueDto){
    ...
    this.confirmationService.confirm({
      ...
      accept: () => {
        this.deleteItemsConfirm(attribute, id);
      }
    });
  }

  deleteItemsConfirm(attribute: ProductAttributeValueDto, id: string){
    this.toggleBlockUI(true);
